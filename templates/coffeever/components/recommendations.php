...
$favs = makeRequest("findBasedOnFavs", ["google_id"=> $_SESSION['subscriberObj']['google_id']], "GET");
  ...
  <div class="container">
    <div class="row slider-text justify-content-center align-items-center">
      ...
      <div class="col-md-7 col-sm-12 text-center ftco-animate">
          <h1 class="mb-3 mt-5 bread">You Might Like!</h1>
                  ...
                  <table class="table">
                      ...
                      <tbody>
                            ...
                            <tr class="text-center" colspan="9">
                                <td class="image-prod">You have not added any favorite coffee yet. Therefore we cannot recommend you coffees. You can find new coffees using the search engine.</td>
                            </tr>
                            <?php endif; ?>
                      </tbody>
                    </table>
