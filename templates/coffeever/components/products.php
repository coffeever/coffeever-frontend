...
<div id="shopify-section-collection-template" class="shopify-section">
    <div class="page-collection filters-sidebar" data-section-id="collection-template"
        ...
        <div class="page-header page-title-default title-size-xlarge color-scheme-default">
                        ...
                        <ol class="breadcrumbs d-flex align-items-center justify-content-center" itemscope
                            ...
                            <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                                <a itemprop="item" href="/kategoriler">
                                    <span itemprop="name">Koleksiyonlar</span><span class="delimiter">/</span>
                                </a>
                                    ...
                                    <?php foreach ($productCategories as $category): ?>
                                        <li class="category_item">
                                            <a class="category_item_link"
                                               href="/kategori/<?php echo $category['alias']; ?>">
                                                <img src="/assets/img/armchair.svg"
                                                     alt="<?php echo $category['title']; ?>"/>
                                                <span class="cat-item-title">
                                                <span><?php echo $category['title']; ?></span><sup><?php echo $category['productCount']; ?></sup>
                                            </span>
                                            </a>
                                        </li>
                                    <?php endforeach; ?>
            ...
            <div class="page-header-bg-wrapper">
                <div class="page-header-bg rellax" data-rellax-speed="-1.5"
                     style="background-color:#f7f7f7;background-image:url(/assets/img/cat-bg-shop.jpg);background-repeat:repeat;background-position:center center;background-size:cover;background-attachment:scroll;"></div>
            </div>
        </div>
                                                    ...
                                                    <?php if (!empty($category['children'])): ?>
                                                        <ul class="children">
                                                            <?php foreach ($category['children'] as $child): ?>
                                                                <li>
                                                                    <a href="/kategori/<?php echo $child['alias']; ?>"><?php echo $child['title']; ?></a>
                                                                </li>
                                                            <?php endforeach; ?>
                                                        </ul>
                                                    <?php endif; ?>
